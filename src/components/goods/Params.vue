<template>
  <div class="params">
        ...
        <el-tab-pane label="动态参数" name="many">
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="showEdit(scope.row.attr_id)">编辑</el-button>
    ...
    <el-dialog :title="'添加'+ titleText" :visible.sync="addDialogVisible" @closed="addDialogClosed" width="50%">
    ...
    <el-dialog :title="'修改'+ titleText" :visible.sync="editDialogVisible" @closed="editDialogClosed" width="50%">
